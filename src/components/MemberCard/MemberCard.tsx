...
export default function TeamCard({ imageUrl, nickname, realName, role }: TeamCardProps) {
  return (
    <div className="relative h-[181px] w-full rounded-md border border-0"
    ...
    >
      ...
      />
      <div className="absolute left-[140px] sm:left-[164px] top-4 right-4 flex flex-col gap-2">
        <div className="flex flex-col gap-0.5">
          <h3 className="text-white font-astonpoliz text-2xl sm:text-[28px] leading-8 sm:leading-9">{nickname}</h3>
          <p className="text-white font-astonpoliz text-sm sm:text-base leading-5 sm:leading-6">"{realName}"</p>
        </div>
        <div className="flex items-center gap-1.5">
          <span
            className="px-1 py-0.5 rounded-sm role-label-style font-astonpoliz text-sm sm:text-base leading-5 sm:leading-6"
          >
            {role}
          </span>
        </div>
        <div className="flex items-center gap-3 sm:gap-4 py-1">
          <a href="#" className="text-white hover:text-gaming-pink transition-colors">
